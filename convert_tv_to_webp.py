#!/usr/bin/env python3
"""
Script pour convertir les images TV en format WebP
"""
...
def convert_tv_to_webp():
    """Convertit toutes les images TV en format WebP"""
    source_folder = "tv_images"
    target_folder = "tv_images_webp"
