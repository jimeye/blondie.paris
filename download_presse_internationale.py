#!/usr/bin/env python3
"""
Script pour télécharger les images de la page Presse Internationale de blondie.paris
"""
...
def download_presse_internationale():
    """Télécharge les images de la page Presse Internationale de blondie.paris"""
    urls_to_try = [
        "https://synthesizer-swordfish-lrgy.squarespace.com/revuedepresse-presseinternationale",
        "http://synthesizer-swordfish-lrgy.squarespace.com/revuedepresse-presseinternationale"
    ]
    
    output_folder = "presse_internationale_images"
        ...
        try:
            ...
            for i, img in enumerate(images):
                ...
                if img_url:
                    ...
                    numbered_filename = f"{i+1:03d}-presse-internationale-blondie-paris-blondie.paris-blondieparis-{filename}"
...
if __name__ == "__main__":
    download_presse_internationale()
