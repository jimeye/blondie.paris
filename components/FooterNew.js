...
export default function Footer() {
  ...
  return (
    <footer key={forceUpdate} className="bg-white text-[#878787] border-t border-[#FFB6C1] menu-font">
      <div className="container mx-auto pt-4 pb-4 md:pb-6 ml-5 lg:ml-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ml-5">
          <div className="text-left md:text-center">
            ...
            <p className="text-lg normal-case mb-3 font-semibold">Nathalie Roland</p>
            <p className="text-base normal-case">Bureau de relations presse</p>
            ...
            <div className="text-left md:text-center">
              ...
              <div className="flex items-center md:justify-center space-x-4 mt-2 mb-2">
                ...
                <a href="tel:+33609496329" className="text-base text-[#878787] hover:text-[#FFB6C1] transition-colors">+33 (0)6 09 49 63 29</a>
              </div>
              <div className="flex items-center md:justify-center space-x-4 mt-2 mb-2">
                ...
                <a href="mailto:nathalie@blondie.paris" className="text-base text-[#878787] hover:text-[#FFB6C1] transition-colors">nathalie@blondie.paris</a>
              </div>
            </div>
        </div>
        <div className="text-left md:text-center mt-6 ml-5">
          <p className="text-base normal-case">© 2025 © BLONDIE.PARIS</p>
          <p className="text-base normal-case">Website design by <a href="tel:+33608251223" className="text-xs uppercase text-[#878787] hover:text-[#FFB6C1] transition-colors">JOSEPH STUDIO CREATIVE</a></p>
          <p className="text-base normal-case">Tous droits réservés</p>
        </div>
      </div>
    </footer>
  )
