...
export default function FooterNew() {
  ...
  return (
    <footer key={forceUpdate} className="bg-white text-[#394140] border-t border-[#FFB6C1] menu-font">
      <div className="container mx-auto pt-2 pb-4 md:pb-6 ml-5 lg:ml-0">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 ml-5">
          <div>
            ...
            <p className="text-base normal-case">Bureau de presse</p>
            <p className="text-base normal-case">Relations publiques</p>
              ...
              <div className="flex items-center space-x-4 mt-2 mb-2">
                ...
                <a href="tel:+33609496329" className="text-base text-[#394140] hover:text-[#FFB6C1] transition-colors">+33 (0)6 09 49 63 29</a>
              </div>
              <div className="flex items-center space-x-4 mt-2 mb-2">
                ...
                <a href="mailto:nathalie@blondie.paris" className="text-base text-[#394140] hover:text-[#FFB6C1] transition-colors">nathalie@blondie.paris</a>
              </div>
            </div>
            <div>
              <p className="text-base normal-case">© 2025 © BLONDIE.PARIS</p>
              <p className="text-base normal-case">Website design by <a href="tel:+33608251223" className="text-xs uppercase text-[#394140] hover:text-[#FFB6C1] transition-colors">JOSEPH CREATIVE STUDIO</a></p>
