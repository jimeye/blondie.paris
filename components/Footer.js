      ...
      <div className="container mx-auto pt-4 pb-8 md:pb-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <p className="text-sm">11 RUE DU SAUVAGE, 13200 ARLES France</p>
            <p className="text-sm">Conseil en relations publiques et communication</p>
            <div className="flex items-center space-x-4 mt-3">
              ...
              <a href="https://wa.me/33609496329" target="_blank" rel="noopener noreferrer" className="text-[#878787] hover:text-[#FFB6C1] transition-colors" aria-label="WhatsApp">
